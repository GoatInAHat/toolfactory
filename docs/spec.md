...
| Kernel | `src/toolfactory/{types,config,mcp,cli}.ts` over `@modelcontextprotocol/server` 2.x and commander | `src/<pkg>/toolfactory/{types,config,mcp,cli}.py` over `mcp` 2.x and argparse |
