...
| `publish-pypi` | `pypi` | `gate`, `package` | `id-token: write` | downloads `release-assets` and gives its prebuilt wheel/sdist to `pypa/gh-action-pypi-publish`, environment `pypi` |
