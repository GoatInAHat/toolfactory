...
describe("toolfactory in a real OpenClaw agent turn", () => {
  it("registers its tools at runtime", async () => {
    ...
    expect(inspected.plugin.toolNames).toEqual(["adopt","bootstrap-repo","build","check","coverage","doctor","eject","gate","init","introspect","package","secrets","unadopt","unpublish","validate","web"]);
  });
