...
|---|---|---|---|
| `adopt` | native | native | native |
| `bootstrap-repo` | native | native | native |
| `build` | native | native | native |
| `check` | native | native | native |
| `coverage` | native | native | native |
| `doctor` | native | native | native |
| `eject` | native | native | native |
| `gate` | native | native | native |
| `init` | native | native | native |
| `introspect` | native | native | native |
| `package` | native | native | native |
| `secrets` | native | native | native |
