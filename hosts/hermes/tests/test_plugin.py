...
def test_register_adds_every_declared_tool() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        register(ctx)
        assert [r["name"] for r in ctx.registrations] == ["adopt","bootstrap-repo","build","check","coverage","doctor","eject","gate","init","introspect","package","secrets","unadopt","unpublish","validate","web"]
